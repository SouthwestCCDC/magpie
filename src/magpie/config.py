...
class MagpieSettings(BaseSettings):
    ...
    # 2. StreamingMultipartHandler: Counts all bytes in the multipart payload (file content, other form
    #    fields, headers, boundaries) during streaming to prevent DoS. Catches malicious clients.
